...
- 云顶之弈版本优先使用 CommunityDragon 的 TFT live 数据文件；若该文件没有版本元数据，则回退到 CommunityDragon 版本索引，不再把英雄联盟 Data Dragon 的版本列表当作云顶版本。补丁公告按当前主版本号生成官方公告链接；例如 `16.17.1` 通常对应 `16.17` 补丁说明，小版本后缀属于客户端数据版本标记。
